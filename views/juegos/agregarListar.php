...
foreach ($juegos as $key => $value) {
    echo '<div class="card mb-4 float-left ml-3" style="width:18rem;">';
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="input-group">
              ...
              <input type="text" name="nombreJuego" class="form-control input-lg" placeholder="nombre completo del juego"required>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="input-group">
              ...
              <textarea name="descripcion"  rows="10" class="form-control" placeholder="Descripcion del juego" required></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="input-group">
